...
export default function ProjectSecondSection() {
  return (
    <main className="bg-background">
      <section className="container max-w-7xl mx-auto pt-10 sm:pt-14 pb-12 sm:pb-20">
        {/* Responsive Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 col-span-12">
            <div className="lg:sticky block lg:top-32">
              {/* Title */}
              <h2 className="font-semibold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gray-100 leading-snug">
                Islamia College Management System
              </h2>

              {/* Description */}
              <p className="text-gray-400 mt-2 text-sm sm:text-base md:text-lg">
                An all-in-one campus management system for students, teachers,
                and staff.
              </p>
