  ...
  return (
    <div className=" bg-black text-white">
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {/* First Card */}
          <div
            className="flex flex-col justify-between rounded-xl border border-gray-800 bg-gray-900/60 backdrop-blur-sm shadow-lg shadow-black/40 overflow-hidden transition hover:scale-[1.02]"
          >
            {/* Image section */}
            ...
            <div className="flex flex-col gap-2 p-4 flex-grow">
              ...
              <p className="text-sm text-gray-400">A streamlined job portal connecting employers and job seekers with seamless applications and postings.</p>
      ...
      <button className="relative flex gap-2 items-center rounded-full font-medium text-white text-[13px]
        ...
        MongoDB
            ...
            <div className="flex items-center justify-between p-4 border-t border-gray-800">
              <button className="flex items-center gap-1 text-xs font-medium bg-gray-800 px-3 py-1.5 rounded-lg border border-gray-700 hover:bg-gray-700 transition">
          ...
          >
            ...
            {/* Content */}
            <div className="flex flex-col gap-2 p-4 flex-grow">
              <h2 className="text-lg font-semibold">Saylani Foundation Management System</h2>
              <p className="text-sm text-gray-400">A digital platform to streamline welfare services, donations, and community support.</p>
        ...
        Shadcn
          ...
          >
            ...
            <div className="flex flex-col gap-2 p-4 flex-grow">
              ...
              <p className="text-sm text-gray-400">A digital platform to manage health records, appointments, and patient care seamlessly.</p>
