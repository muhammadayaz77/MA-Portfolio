...
export default function ProjectSecondSection() {  
  return (
    <main className="bg-background">
      <section className="container max-w-7xl mx-auto pt-14 pb-22">
  ...
  <div className="absolute inset-0 bg-black/40 rounded-xl pointer-events-none" />
          ...
          <div className="md:col-span-4">
            <div className="sticky top-32">
              <h2 className="font-semibold text-4xl">Islamia College Management System</h2>
              <p className="text-gray-400 mt-2">
              An all-in-one campus management system for students, teachers, and staff.
              </p>
